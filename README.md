...
> **🔬 Experiment:** An XGBoost classifier was tested on the `xgboost` branch achieving **58.69% accuracy** (+5.45% improvement over Random Forest). The main branch retains Random Forest as the production model.Head over to the xgboost branch to check it out.
